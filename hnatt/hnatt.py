...
class HNATT():
    ...
    def load_weights(self, saved_model_dir, saved_model_filename, saved_tokenizer_filename):
        with CustomObjectScope({'Attention': Attention}):
            ...
            tokenizer_path = os.path.join(saved_model_dir, saved_tokenizer_filename)
    ...
    def train(self, train_x, train_y,
        ...
        if saved_model_filename:
            callbacks.append(
                ModelCheckpoint(
                    filepath=os.path.join(saved_model_dir, '{epoch:04d}_'+saved_model_filename),
                    monitor='val_acc',
        ...
        self.model.save(os.path.join(saved_model_dir, saved_model_filename))
